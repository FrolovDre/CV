...
export const profile: Profile = {
  ...
  about:
    'Выпускник МГУ и магистрант НИУ ВШЭ (бизнес‑информатика, цифровые инновации). Увлекаюсь цифровыми продуктами, которые решают реальные задачи пользователей и приносят бизнес‑ценность. Сильные аналитические навыки, опыт работы в гибких методологиях и понимание полного жизненного цикла продукта.',
  whatILookFor:
    'Стажировка / Junior Product Manager, полная занятость, Москва / гибрид. Хочу применять знания по продуктовой аналитике, управлению проектами и AI для развития цифровых продуктов.',
  contact: {
  ...
  experience: [
    ...
    },
    {
      id: 'vip-assistant',
      company: 'Туристский комплекс «Клязьминское водохранилище»',
      role: 'Помощник менеджера по работе с VIP‑клиентами',
      period: '09.2019 – 06.2020',
      description: [
        'Подготовка и согласование договоров с клиентами',
        'Коммуникация с жильцами и координация сервисных подразделений'
      ]
    }
  ],
  skills: [
  ...
  certificates: [
    'Process Communication Model (2025)',
    'Курсы IBS: управление проектами, коммуникации, управление рисками и изменениями, требования, Confluence/Jira, промпт‑инжиниринг и др. (2024–2025)'
  ],
  languages: [
    { name: 'Русский', level: 'родной' },
    { name: 'Английский', level: 'C1' },
    { name: 'Немецкий', level: 'A2' },
    { name: 'Французский', level: 'A1' }
  ]
};